...
for i in temperature:
    ...
    for j in group:
        ...
        for k in replication:
            ...
            frame_list = np.r_[0:looms[0]]   
            replicate_loom_startles[k] = len(spikes_position_new(tr, frame_list))*35351/filter_speed_low_pass(tr)[frame_list].compressed().shape[0]
...
fn1 = out_dir + 'preloom_startles_normalized.p'
pickle.dump(loom_startles, open(fn1, 'wb')) # 'wb' is for write binary

fn2 = out_dir + 'preloom_startles_normalized_std.p'
