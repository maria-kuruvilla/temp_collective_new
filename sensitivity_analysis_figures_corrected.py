"""
Date - Tue 7 Dec 2021
Goal - one code to make prediction figures for different thresholds to show sensitivity using corrected data file
...
data2 = pd.read_csv('../../data/temp_collective/roi/sensitivity_analysis_new_corrected.csv')
...
if args.a_string=='latency_seconds_predictions_one_model_threshold_sensitivity_corrected.csv':
    ...
    if args.verbose==True:
        ...
        out_dir = '../../output/temp_collective/roi_figures/predictions/latency_seconds_predictions_w_data_threshold_sensitivity_corrected.png'
        ...
        out_dir = '../../output/temp_collective/roi_figures/predictions/latency_seconds_predictions_wo_data_threshold_sensitivity_corrected.png'
        fig.savefig(out_dir, dpi = dpi, bbox_inches="tight")
...
#prop startles 
if args.a_string=='prop_startles_predictions_one_model_threshold_sensitivity_corrected.csv':
    ...
    if args.verbose==True:
        ...
        plt.legend(fontsize=fs, loc='upper right', title = 'Startle threshold', framealpha = 0.5)
        out_dir = '../../output/temp_collective/roi_figures/predictions/prop_startles_predictions_w_data_threshold_sensitivity_corrected.png'
        fig.savefig(out_dir, dpi = dpi, bbox_inches="tight")
        ...
        plt.legend(fontsize=fs, loc='upper right', title = 'Startle threshold', framealpha = 0.5)
        out_dir = '../../output/temp_collective/roi_figures/predictions/prop_startles_predictions_wo_data_threshold_sensitivity_corrected.png'
        fig.savefig(out_dir, dpi = dpi, bbox_inches="tight")
...
if args.a_string=='speed_predictions_one_model_speed_threshold_sensitivity_corrected.csv':
    ...
    if args.verbose==True:
        ...
        out_dir = '../../output/temp_collective/roi_figures/predictions/speed_predictions_w_data_speed_threshold_sensitivity_corrected.png'
        fig.savefig(out_dir, dpi = dpi, bbox_inches="tight")
        ...
        plt.legend(fontsize=fs, loc='upper right', title = 'Speed threshold', framealpha = 0.5)
        out_dir = '../../output/temp_collective/roi_figures/predictions/speed_predictions_wo_data_speed_threshold_sensitivity_corrected.png'
        fig.savefig(out_dir, dpi = dpi, bbox_inches="tight")
