...
Goal - to separate the loom data from the rest - with the high speeds and accelerations masked
"""
...
with open('../../data/temp_collective/roi/stats_loom_low_pass_data.csv', mode='w') as stats_speed:
...
fn1 = out_dir + 'max_loom_speed_low_pass.p'
pickle.dump(max_loom_speed, open(fn1, 'wb')) # 'wb' is for write binary

fn2 = out_dir + 'max_loom_speed_low_pass_std.p'
